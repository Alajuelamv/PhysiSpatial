...
plotPurity(scores="visium_estimate_score.gct", samples="all_samples", platform="affymetrix",output.dir ="./output_estimate" )
...
kmeans_iris = kmeans(iris_transform, centers = 3, nstart = 50)
...
write.csv(set_up, file = "uwu4.csv",row.names = FALSE,quote = FALSE,col.names = FALSE)
